...
4候補すべてを採用する季節に合わせてください。各候補には名称、短い訴求、季節設計、構成、味・食感・五色、1食分材料、数値を伴う具体的手順、季節に応じた安全上の注意、経営審査済みの原価・粗利益見積もりと前提、完成写真用の厳密な盛り付け仕様、10専門家の反証後に完成させたqualityReviewを含めてください。`;
}

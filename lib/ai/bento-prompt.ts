...
名称、ジャンル、構成、味、食感、季節設計、独自の特徴、原価概算は選択案を保持してください。1食分材料、数値を伴う具体的手順、季節に応じた安全上の注意、経営審査済みの原価・粗利益見積もりと前提、完成写真用の厳密な盛り付け仕様、10専門家の反証後に完成させたqualityReviewを追加してください。候補を別料理へ置き換えないでください。`;
}

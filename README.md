...
トップページの「お弁当を考える（家庭用）」では、幼児から80代までの対象年齢、性別、量多め、春・夏・秋・冬・おまかせ、1食分の食材予算を選択できます。販売価格・原価率・粗利益は使わず、スーパー小売価格による主材料、野菜・副菜、主食・調味料の予算内訳を作ります。年齢に合う一口サイズと量、季節の旬・香り・色・気候、朝の家庭調理、冷めた品質、弁当安全を確認し、使い捨て販売容器ではなく再利用可能な家庭用弁当箱のレイアウトで完成写真を生成します。「おまかせ」は日本時間の基準日から季節を判断します。

居酒屋画面でも、弁当・定食・コースではなく「日替わりの逸品」一皿の比較候補を4案生成し、選んだ1件だけ1〜2人前のレシピ、仕込み、注文後の提供時間、採算と完成写真を生成・確認できます。

トップページの「今日の夜ご飯を考える」では、1〜6人、男性多め・女性多め・半々・男性だけ・女性だけ、和食・洋食・韓国料理・中華料理・混合、春・夏・秋・冬・おまかせ、全員分の予算、任意の細かい指示を指定できます。主菜1品、副菜2〜6品、汁物1品を必須構成とし、候補はLuna、選んだ献立の詳細だけTerraで生成します。選択季節を旬、気候、香り、色、食感、温度、汁物、安全へ反映し、「おまかせ」は日本時間の基準日から判断します。和食・洋食・韓国・中華・味覚構成・家庭栄養・予算時短・食品安全の8専門家が相互検証する指示をAPI内部で実行し、発言、反対意見、却下案、採点、修正理由は返さず、統合結論だけを表示して出力費用を抑えます。統合結論は主役、器、配膳方式、食卓配置、色彩、人数分の量、文化、主食をまとめた短い写真設計へ変換し、詳細生成後にGPT Image 2の1024×1024・low品質で完成写真を1枚自動生成します。画像生成中は経過秒と混雑時4〜5分の目安を表示し、完了前の候補変更による中断を防ぎます。

販売用弁当、家庭用弁当、居酒屋、夜ご飯は、詳細生成後の「このレシピを保存」からブラウザ専用ライブラリへ保存できます。家庭用弁当と夜ご飯は生成済みの完成画像も保存します。`/saved`では4種類を絞り込み、生成時点の予算、レシピ、段取り、品質・安全情報を再確認できます。

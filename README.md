...
トップページの「今日の夜ご飯を考える」では、1〜6人、男性多め・女性多め・半々・男性だけ・女性だけ、和食・洋食・韓国料理・中華料理・混合、春・夏・秋・冬・おまかせ、全員分の予算、任意の細かい指示を指定できます。主菜1品、副菜2〜6品、汁物1品を必須構成とし、候補はLuna、選んだ献立の詳細だけTerraで生成します。選択季節を旬、気候、香り、色、食感、温度、汁物、安全へ反映し、「おまかせ」は日本時間の基準日から判断します。和食・洋食・韓国・中華・味覚構成・家庭栄養・予算時短・食品安全の8専門家が相互検証する指示をAPI内部で実行し、発言、反対意見、却下案、採点、修正理由は返さず、統合結論だけを表示して出力費用を抑えます。夜ご飯では画像APIを使用しません。
